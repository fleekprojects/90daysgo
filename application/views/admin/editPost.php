         ...
         <div class="x_panel">
            ...
            <div class="x_content">
               <div class="col-md-10 col-md-offset-1">
                  <form class="form-horizontal" method="post" id="Editform" action="<?= base_url();?>admin/Posts/EditRecord">
                     <div class="col-md-12">
                        <label class="control-label" for="example-text-input">Post Type</label>
                        <select name="post_type" class="form-control">
							<option value="1" <?= ($rec['post_type']=='1'?'selected':''); ?>>Blog</option>
							<option value="0" <?= ($rec['post_type']=='0'?'selected':''); ?>>Page</option>
						</select>
                     </div>
                     <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <input type="text" name="slug" value="<?= $rec['slug']; ?>" placeholder="Enter Post Slug" class="form-control">
                     </div>
                     <div class="col-md-12">
					  ...
					  <div class="form-group">
						...
						<div  class="col-md-2">
						<img src="<?=base_url();?>assets/front/uploads/posts/<?= ($rec['image'] != "" ? $rec['image'] : "dummy.png"); ?>"  style="max-height:50px;" />
						</div>
					  </div>
                     </div>
                     <div class="col-md-12">
