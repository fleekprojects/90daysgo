<section class="_dashboard_banner" style="background-image:url(<?= base_url()?>assets/front/images/banner.jpg">
		...
		<div class="container">
			...
			<div class="row _product_before_after_row">
				<div class="col-md-12 col-xs-12 col-sm-6 _product_before_col">
					<?php 
					if(count($ordercourses) > 0):
					foreach($ordercourses as $ordercourse): ?>
					<div class="col-md-3 col-xs-12 col-sm-3 _product_ba_img">
						<a href="<?=base_url()?>start-workout/<?= $ordercourse['pslug']?>/<?= $ordercourse['slug']?>" title="<?= $ordercourse['title']?> Workout">
